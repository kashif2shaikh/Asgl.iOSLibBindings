...
{
	// @interface FLKAutoLayoutPredicate (UIView)
	[Category]
	[BaseType (typeof(UIView))]
	interface UIView_FLKAutoLayoutPredicate
	{
		...
		[Export ("applyPredicate:toView:attribute:")]
		NSLayoutConstraint ApplyPredicate (FLKAutoLayoutPredicate predicate, UIView toView, NSLayoutAttribute attribute);
		...
		[Export ("applyPredicate:toView:fromAttribute:toAttribute:")]
		NSLayoutConstraint ApplyPredicate (FLKAutoLayoutPredicate predicate, UIView view, NSLayoutAttribute fromAttribute, NSLayoutAttribute toAttribute);
	}

	// typedef NSLayoutConstraint * (^predicateBlock)(FLKAutoLayoutPredicate);
	delegate NSLayoutConstraint predicateBlock (FLKAutoLayoutPredicate arg0);

	// @interface FLKAutoLayoutPredicateList : NSObject
	[BaseType (typeof(NSObject))]
	interface FLKAutoLayoutPredicateList
	{
		// +(id)predicateListFromString:(NSString *)string;
		[Static]
		[Export ("predicateListFromString:")]
		NSObject PredicateListFromString (string str);

		// -(NSArray *)iteratePredicatesUsingBlock:(predicateBlock)block;
		[Export ("iteratePredicatesUsingBlock:")]
		//[Verify (StronglyTypedNSArray)]
		NSObject[] IteratePredicatesUsingBlock (predicateBlock block);
	}

	// @interface FLKAutoLayoutDebug (NSLayoutConstraint)
	[Category]
	[BaseType (typeof(NSLayoutConstraint))]
	interface NSLayoutConstraint_FLKAutoLayoutDebug
	{
	}
	...
	interface UIView_FLKAutoLayout
	{
		...
		//[Verify (StronglyTypedNSArray)]
		NSObject[] AlignAllEdges (string top, string leading, string bottom, string trailing, UIView view);
		...
		//[Verify (StronglyTypedNSArray)]
		NSObject[] AlignBottomAndTrailing (string bottom, string trailing, UIView view);
		...
		//[Verify (StronglyTypedNSArray)]
		NSObject[] AlignLeadingAndTrailing (string leading, string trailing, UIView view);
...
//	// @interface FLKAutoLayoutDebug (UIView)
//	[Category]
//	[BaseType (typeof(UIView))]
//	interface UIView_FLKAutoLayoutDebug
//	{
//		// @property (nonatomic, strong) NSString * flk_nameTag;
//		[Export ("flk_nameTag", ArgumentSemantic.Strong)]
//		string Flk_nameTag { get; set; }
//
//		// -(void)flk_exerciseAmbiguityInLayout:(BOOL)recursive;
//		[Export ("flk_exerciseAmbiguityInLayout:")]
//		void Flk_exerciseAmbiguityInLayout (bool recursive);
//
//		// -(NSString *)flk_autolayoutTrace;
//		[Export ("flk_autolayoutTrace")]
//		[Verify (MethodToProperty)]
//		string Flk_autolayoutTrace { get; }
//	}
}

//namespace iOSLibBindings.FLKAutoLayout
//{
//	
//	//[Verify (ConstantsInterfaceAssociation)]
//	partial interface Constants
